...
<%
 	...
 	Select1 = new String(Select1.getBytes("ISO-8859-1"));
 	String Select2=request.getParameter("Select2");
 	Select2 = new String(Select2.getBytes("ISO-8859-1"));
 	String Select3=request.getParameter("Select3");
 	Select3 = new String(Select3.getBytes("ISO-8859-1"));
 	...
 	Select4 = new String(Select4.getBytes("ISO-8859-1"));
 	Select5 = new String(Select5.getBytes("ISO-8859-1"));
 	Select6 = new String(Select6.getBytes("ISO-8859-1"));
 	...
 	Select7 = new String(Select7.getBytes("ISO-8859-1"));
 	Select8 = new String(Select8.getBytes("ISO-8859-1"));
 	Select9 = new String(Select9.getBytes("ISO-8859-1"));
